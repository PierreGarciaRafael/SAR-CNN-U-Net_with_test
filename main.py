...
parser.add_argument('--eval_set', dest='eval_set', default=datasetdir+'/Test/256x256/clean/', help='dataset for eval in training')
parser.add_argument('--test_set', dest='test_set', default=datasetdir+'/Test/256x256/clean/', help='dataset for testing')
